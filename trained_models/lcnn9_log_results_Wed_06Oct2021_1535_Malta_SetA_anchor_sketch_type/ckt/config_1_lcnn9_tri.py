...
#    pretrain=True
    ...
    if (not do_cross_validation) and fixed_testset: #For Fixed training and test set
        ...
        if (testdata == "UoM"): 
            ...
            # test_meta_file = os.path.join(dataset_dir, 'GT','Hiding_game','Grad-CAM_Mean_with_blur_txt_files','Norm_Sorted_Set_test_Vgg16_GT_as_Rank1_70percent_hidden.txt') # Rank1 as GT
        elif (testdata == "VM"):
...
#    restore_checkpoint = True # If set true, you need to set checkpoint_file below to a valid path
    checkpoint_file = project_dir /'log_results' /'log_results_Mon_27Sep2021_1737_Malta_SetA_anchor_sketch_type'/'ckt'/'vgg_tri_2_Mon_27Sep2021_214648_epoch30.pth'
    ...
    # lcnn9_tri_pth= project_dir / 'log_results'/ 'log_results_Tue_21Sep2021_1806_Malta_SetA_anchor_sketch_type'/ 'ckt'/ 'lcnn9_tri_Tue_21Sep2021_200954_epoch30.pth'
    data_mix=False
